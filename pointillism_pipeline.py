...
def main() -> None:
    ...
    parser.add_argument("--spacing-mm", type=float, default=0.4, help="Dot spacing in mm (default: 0.4).")
    parser.add_argument("--dot-mm", type=float, default=0.3, help="Dot diameter in mm (default: 0.3).")
